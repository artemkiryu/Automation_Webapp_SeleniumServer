 ...
 */
public class CustomQuestionsPage extends CommonActionsPage{

    @FindBy(xpath = "//input[@id='submitAndClose']")
    public static WebElement SAVE_BUTTON;
    @FindBy(xpath = "//div[contains(.,'Custom Registration Questions')]/button[text()='Add New']")
    ...
    @FindBy(xpath = "//input[@id='queClass']")
    ...
    public CustomQuestionsPage(WebDriver driver)
    ...
    private void enterInputFieldSize(String size) throws Exception{
        ...
        type(INPUT_SIZE_TEXTBOX, size, true);
    ...
    private void enterMinimumCharacter(String size) throws Exception{
        ...
        type(MINIMUM_CHARACTER_TEXTBOX, size, true);
    ...
    private void enterMaximumCharacter(String size) throws Exception{
        ...
        type(MAXIMUM_CHARACTER_TEXTBOX, size, true);
    ...
    public List<String> getCustomQuestionData() {
        ...
        List<String> customQuestionData = new ArrayList<>();
        for (WebElement e : elements) {
            customQuestionData.add(e.getText().trim());
        }
